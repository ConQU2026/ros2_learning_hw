...
static const _Climb_Request_type_support_symbol_names_t _Climb_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lr_interfaces, srv, Climb_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lr_interfaces, srv, Climb_Request)),
  }
};
...
{
  return &::lr_interfaces::srv::rosidl_typesupport_cpp::Climb_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lr_interfaces, srv, Climb_Request)() {
  return get_message_type_support_handle<lr_interfaces::srv::Climb_Request>();
}
...
static const _Climb_Response_type_support_symbol_names_t _Climb_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lr_interfaces, srv, Climb_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lr_interfaces, srv, Climb_Response)),
  }
};
...
{
  return &::lr_interfaces::srv::rosidl_typesupport_cpp::Climb_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lr_interfaces, srv, Climb_Response)() {
  return get_message_type_support_handle<lr_interfaces::srv::Climb_Response>();
}
...
static const _Climb_type_support_symbol_names_t _Climb_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lr_interfaces, srv, Climb)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lr_interfaces, srv, Climb)),
  }
};
...
{
  return &::lr_interfaces::srv::rosidl_typesupport_cpp::Climb_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, lr_interfaces, srv, Climb)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<lr_interfaces::srv::Climb>();
}
